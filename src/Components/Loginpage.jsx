...
import img1 from '../assets/test.png'; // Your assets
  ...
  return (
    <div className="min-h-screen bg-[#e0bfa8] flex items-center justify-center">
      <div className='flex w-[60%] min-h-[500px] lg:min-h-[600px] bg-slate-400 justify-center rounded-3xl shadow-lg my-0'>
        <img src={showSignup ? img5 : img1} alt="Image" className="items-center m-2 ml-3 mt-28 h-60 w-60 lg:h-80 lg:w-80 lg:mb-0" />
          ...
          <div className='mt-9 mx-7'>
            ...
            <form onSubmit={showSignup ? handleSignup : handleLogin}>
              <div className="mb-5">
                ...
                <input
                  type="email"
                  className="block w-full mt-1 border-gray-300 rounded-md shadow-sm outline-none"
                  id="email"
                  placeholder={showSignup ? 'Your Email for Signup' : 'Your Registered Email(test@gmail.com)'}
                  value={email}
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  required
                />
                <div className="absolute text-gray-600 cursor-pointer right-3 top-3" onClick={togglePasswordVisibility}>
              ...
              {showSignup ? (
                <div className="relative mb-6">
                  ...
                  <input
                    ...
                    onChange={(e) => setConfirmPassword(e.target.value)} // Fixed state update for ConfirmPassword
                    required
                  />
                  <div className="absolute text-gray-600 cursor-pointer right-3 top-3" onClick={togglePasswordVisibility}>
                    {showPassword ? <Visibility /> : <VisibilityOff />}
              ...
              <button className="w-full px-4 py-2 text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50" type="submit">
                {showSignup ? 'Sign Up' : 'Login'}
              </button>
            </form>
              ...
              <p className="text-sm text-gray-600">
                {showSignup ? (
                  <>
                    ...
                    <button className="text-indigo-600 hover:text-indigo-800" onClick={() => setShowSignup(false)}>
                      Log in
                    </button>
                  </>
                ) : (
                  <>
                    ...
                    <button className="text-indigo-600 hover:text-indigo-800" onClick={() => setShowSignup(true)}>
                      Sign up
                    </button>
                  </>
                )}
